"""add type code column to hpo

Revision ID: 147af1fa5798
Revises: 335d191204c1
Create Date: 2019-01-11 10:06:35.641544
...
def upgrade_rdr():
    ...
    op.add_column('hpo', sa.Column('organization_type_code', sa.String(length=20), nullable=True))
    # ### end Alembic commands ###


def downgrade_rdr():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('hpo', 'organization_type_code')
    # ### end Alembic commands ###
